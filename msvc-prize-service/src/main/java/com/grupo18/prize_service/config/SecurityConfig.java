package com.grupo18.prize_service.config;
    ...
    @Bean public SecurityFilterChain filterChain(HttpSecurity http, JwtAuthenticationConverter conv) throws Exception {
        http.csrf(c -> c.disable())
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/prizes/**","/api/v2/prizes/**").hasAnyRole("ADMIN","ORGANIZADOR","JUGADOR")
                .requestMatchers("/api/v1/prizes/**","/api/v2/prizes/**").hasAnyRole("ADMIN","ORGANIZADOR")
