...
public class MatchControllerV2 {
    ...
    @GetMapping @Operation(summary = "Listar matches")
    ...
    @GetMapping("/{id}") @Operation(summary = "Buscar Match por ID")
    ...
    @PostMapping @Operation(summary = "Crear Match")
    ...
    @PutMapping("/{id}") @Operation(summary = "Actualizar Match")
    ...
    @DeleteMapping("/{id}") @Operation(summary = "Eliminar Match")
