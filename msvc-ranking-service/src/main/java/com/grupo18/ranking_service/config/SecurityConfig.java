package com.grupo18.ranking_service.config;
    ...
    @Bean public SecurityFilterChain filterChain(HttpSecurity http, JwtAuthenticationConverter conv) throws Exception {
        http.csrf(c -> c.disable())
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/rankings/**","/api/v2/rankings/**").hasAnyRole("ADMIN","ORGANIZADOR","JUGADOR")
                .requestMatchers("/api/v1/rankings/**","/api/v2/rankings/**").hasAnyRole("ADMIN","ORGANIZADOR")
