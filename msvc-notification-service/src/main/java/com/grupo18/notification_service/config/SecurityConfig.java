package com.grupo18.notification_service.config;
    ...
    @Bean public SecurityFilterChain filterChain(HttpSecurity http, JwtAuthenticationConverter conv) throws Exception {
        http.csrf(c -> c.disable())
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/notifications/**","/api/v2/notifications/**").hasAnyRole("ADMIN","ORGANIZADOR","JUGADOR")
                .requestMatchers("/api/v1/notifications/**","/api/v2/notifications/**").hasAnyRole("ADMIN","ORGANIZADOR")
