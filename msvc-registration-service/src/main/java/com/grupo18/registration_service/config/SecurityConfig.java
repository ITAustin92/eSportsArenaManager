package com.grupo18.registration_service.config;
    ...
    @Bean public SecurityFilterChain filterChain(HttpSecurity http, JwtAuthenticationConverter conv) throws Exception {
        http.csrf(c -> c.disable())
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/registrations/**","/api/v2/registrations/**").hasAnyRole("ADMIN","ORGANIZADOR","JUGADOR")
                .requestMatchers("/api/v1/registrations/**","/api/v2/registrations/**").hasAnyRole("ADMIN","ORGANIZADOR")
