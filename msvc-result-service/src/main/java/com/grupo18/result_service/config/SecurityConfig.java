package com.grupo18.result_service.config;
    ...
    @Bean public SecurityFilterChain filterChain(HttpSecurity http, JwtAuthenticationConverter conv) throws Exception {
        http.csrf(c -> c.disable())
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/results/**","/api/v2/results/**").hasAnyRole("ADMIN","ORGANIZADOR","JUGADOR")
                .requestMatchers("/api/v1/results/**","/api/v2/results/**").hasAnyRole("ADMIN","ORGANIZADOR")
