...
public class ResultControllerV2 {
    ...
    @GetMapping @Operation(summary = "Listar results")
    ...
    @GetMapping("/{id}") @Operation(summary = "Buscar Result por ID")
    ...
    @PostMapping @Operation(summary = "Crear Result")
    ...
    @PutMapping("/{id}") @Operation(summary = "Actualizar Result")
    ...
    @DeleteMapping("/{id}") @Operation(summary = "Eliminar Result")
